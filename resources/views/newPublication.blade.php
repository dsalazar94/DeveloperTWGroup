...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand">Nueva publicación</a>
        ...
        <div class="card-body">
            <form action="{{url('request-newPublication')}}" method="POST" id="regForm">
				{{ csrf_field() }}
                ...
                <div class="form-group">
					...
					<input class="form-control py-4" id="inputTitle" type="text" name="title" placeholder="Ingrese el título" />
					@if ($errors->has('title'))
				...
				<div class="form-group mt-4 mb-0">
					<button class="btn btn-primary btn-block" type="submit">Ingresar publicación</button>
				</div>
            </form>
            </div>
        </div>
